          ...
          <div className='col-md-8 col-sm-7 col-12'>
            ...
            >
              ...
              <ExpansionPanelDetails>
                <p>
                  Using WP Age Gate Pro is pretty straight forward. There is an easy to use
                  ...
                  about this here which explains all the setings.
                </p>
              </ExpansionPanelDetails>
            </ExpansionPanel>
                ...
                <ul className='articles-section list-unstyled'>
                    ...
                    <div className='article-description'>
                      <p>
                        <a href='javascript:void(0)'>
                          English breakfast.jpeg tea with desert
                          donut
                        </a>
                      </p>
                  ...
                  <li className='articles'>
                    ...
                    <div className='article-description'>
                      <p>
                        <a href='javascript:void(0)'>
                          Co-founder trying to explain his idea to his
                          employers
                        </a>
                      </p>
                      <div className='meta-wrapper'>
