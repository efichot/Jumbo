              ...
              <ul className="color-option">
                ...
                <li>
                  <a
                    ...
                    className={`bg-deep-orange ${themeColor === DEEP_ORANGE &&
                      'active'}`}
                  />
                </li>
                ...
                <li>
                  <a
                    ...
                    className={`bg-deep-purple ${themeColor === DEEP_PURPLE &&
                      'active'}`}
                  />
                </li>
                <li>
              ...
              <ul className="color-option cr-op-dark-sidebar">
                <li>
                  <a
                    ...
                    className={`bg-indigo ${themeColor === DARK_INDIGO &&
                      'active'}`}
                  />
                </li>
                <li>
                  <a
                    ...
                    className={`bg-cyan ${themeColor === DARK_CYAN &&
                      'active'}`}
                  />
                </li>
                <li>
                  <a
                    ...
                    className={`bg-amber ${themeColor === DARK_AMBER &&
                      'active'}`}
                  />
                </li>
                <li>
                  <a
                    ...
                    className={`bg-deep-orange ${themeColor ===
                ...
                <li>
                  <a
                    ...
                    className={`bg-pink ${themeColor === DARK_PINK &&
                      'active'}`}
                  />
                </li>
                <li>
                  <a
                    ...
                    className={`bg-blue ${themeColor === DARK_BLUE &&
                      'active'}`}
                  />
                </li>
                <li>
                  <a
                    ...
                    className={`bg-deep-purple ${themeColor ===
                ...
                <li>
                  <a
                    ...
                    className={`bg-green ${themeColor === DARK_GREEN &&
                      'active'}`}
                  />
                </li>
              </ul>
